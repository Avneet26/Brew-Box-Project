...
export default function CoffeeCard({ imgsrc, name, roastLevel, price, quantity = 1 }: PropTypes) {
  ...
  return (
    <div className="bg-white shadow-gray-400 shadow-md rounded-lg border border-gray-200 hover:shadow-xl transition flex flex-col justify-content-between align-items-center items-center mb-7 w-full max-w-sm">
      <img
        src={imgsrc}
        alt={name}
      ...
      <div className="p-4">
        <h2 className="text-xl mb-4 text-center">{name}</h2>
